...
if __name__ == '__main__':
    ...
    inp = [inp[i] for i in range(0, len(inp)) if i != col_index]
    ...
    train_x_2 = list()
    for t in train_x:
        s = [t[i] for i in range(0, len(t)) if i != col_index]
        train_x_2.append(s)
    ...
    classifier = RandomForestClassifier(n_estimators=tree_num, criterion=attribute)
