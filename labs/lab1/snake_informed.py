...
def down(snake, green):
    ...
    if y - 1 >= 0 and (x, y - 1) not in snakes:  # proverka za granicite na tablata
        new_curr = (x, y - 1)
...
def up(snake, green):
    ...
    if y + 1 < 10 and (x, y + 1) not in snakes:
        new_head = (x, y + 1)
...
def right(snake, green):
    ...
    if x + 1 < 10 and (x + 1, y) not in snakes:
        new_head = (x + 1, y)
        if new_head in green_app:
            green_app.remove(new_head)
            snakes.append(new_head)
...
def left(snake, green):
    ...
    if x - 1 >= 0 and (x - 1, y) not in snakes:
        new_head = (x - 1, y)
        if new_head in green_app:
            green_app.remove(new_head)
            snakes.append(new_head)
...
class Snake(Problem):
    ...
    def successor(self, state):
        ...
        if direction == 'South':
            ...
            new_snake, new_green = down(snake, green)
            if new_snake != snake:
                successors['ProdolzhiPravo'] = (new_snake, new_direction, new_green)

        elif direction == 'North':
            new_direction = direction
            new_snake, new_green = up(snake, green)
            if new_snake != snake:
                successors['ProdolzhiPravo'] = (new_snake, new_direction, new_green)

        elif direction == 'East':
            new_direction = direction
            new_snake, new_green = right(snake, green)
            if new_snake != snake:
                successors['ProdolzhiPravo'] = (new_snake, new_direction, new_green)

        elif direction == 'West':
            new_direction = direction
            new_snake, new_green = left(snake, green)
            if new_snake != snake:
                successors['ProdolzhiPravo'] = (new_snake, new_direction, new_green)
...
if __name__ == '__main__':
    ...
    snake = Snake((initial, direction, green_apples))
