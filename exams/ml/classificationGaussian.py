...
if __name__ == '__main__':
    ...
    features = [[float(t) for t in el[:-1]] for el in dataset]
    classes = [el[-1] for el in dataset]

    train_x = features[:int(0.85 * len(features))]
    train_y = classes[:int(0.85 * len(classes))]

    test_x = features[int(0.85 * len(features)):]
    test_y = classes[int(0.85 * len(classes)):]
